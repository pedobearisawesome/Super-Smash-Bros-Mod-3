...
public class EntityMario extends EntityMob {
	
	private float heightOffset = 0.5f;
	private static final String __OBFID = "CL_00001682";
    
	public EntityMario(World par1World) {
		super(par1World);
    ...
    {
        return Main.MODID + ":Mario_Living";
    }
